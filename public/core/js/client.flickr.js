...
function init(targets) {
  ...
  var urlSrc = document.FLICKR_API_URI || Hogan.compile(Core.util.format("%s/php/flickr-api.php?count={{{count}}}&display={{{display}}}&size=q&layout=x&source={{{source}}}&user={{{id}}}", Core.root));
